...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
   ...
   $connect = mysql_connect("localhost", "root", ""); // Establishing Connection with Server
  		mysql_select_db("phpproject") or die("Cant Connect to database"); // Selecting Database from Server
		
		$check = mysql_query("SELECT * FROM slogin WHERE Username='".$USN."'") or die("Check Query");
