...
<body>
    <div id="heading">
<h1 class="h1"> MANAGE COMPANIES</h1>
        </div>
    <hr>
    <form>
    <div>
        ...
        <div class="divsearch"><a href="companyregistration.php" class="all">ADD COMPANY</a></div>
       ...
       <?php
           ...
           <tr>
              ...
              exam date <?php echo $row->examdate."<br>";
                ...
                <a href="editcompany.php?pid=<?php echo $row->id ?>" title="click here to edit"><img src="image\editbtn.gif" ></a><a href="deleteproduct.php?pid=<?php echo $row->id ?>" title="click here to delete"><img src="image\delete.gif"></a><br><a href="view.php?pid=<?php echo $row->id ?>"><img src="image/view.png"></a>
                       </td>
                       <td>&nbsp;</td>
                       <td>&nbsp;</td>
                       <td>&nbsp;</td>
